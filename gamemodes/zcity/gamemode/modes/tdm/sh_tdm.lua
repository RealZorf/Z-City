...
AddItemToBUY( "Colt Python", "Weapon", "weapon_python", 650, "Pistols", {} )
AddItemToBUY( "HK VP9", "Weapon", "weapon_vp9hk", 550, "Pistols", {} )
AddItemToBUY( "SIG P220", "Weapon", "weapon_p220", 650, "Pistols", {} )
AddItemToBUY( "SIG P250", "Weapon", "weapon_p250", 500, "Pistols", {} )
AddItemToBUY( "PL-15", "Weapon", "weapon_pl15", 500, "Pistols", {"supressor4"} )
AddItemToBUY( "Beretta M9 Commando", "Weapon", "weapon_m9berettacommando", 500, "Pistols", {} )
...
AddItemToBUY( "G3A3", "Weapon", "weapon_g3a3", 3300, "Assault", {"optic9"} )
AddItemToBUY( "MK18", "Weapon", "weapon_mk18", 3000, "Assault", {"holo14","laser4","grip3"} )
AddItemToBUY( "LR-300", "Weapon", "weapon_lr300", 2800, "Assault", {"holo15","grip3"} )
AddItemToBUY( "IMBEL IA2", "Weapon", "weapon_ia2", 2900, "Assault", {"holo15","grip3"} )
AddItemToBUY( "vz. 58", "Weapon", "weapon_vz58", 2600, "Assault", {"holo6"} )
AddItemToBUY( "SCAR-H", "Weapon", "weapon_scarh", 3800, "Assault", {"holo14","supressor7","grip3"} )
AddItemToBUY( "XM8", "Weapon", "weapon_xm8", 3200, "Assault", {"optic7"} )
AddItemToBUY( "FN FAL", "Weapon", "weapon_fnfal", 3300, "Assault", {"optic9"} )
AddItemToBUY( "AK-103D", "Weapon", "weapon_ak103d", 3200, "Assault", {"holo6","grip_ak74"} )
...
AddItemToBUY( "PP-19 Vityaz", "Weapon", "weapon_vityaz", 1500, "Submachine", {} )
