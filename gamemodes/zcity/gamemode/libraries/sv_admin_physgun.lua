...
local function setHeldTarget(holder, target, rag)
...
hook.Add("StartCommand", "ZC_AdminPhysgunPrime", function(ply, cmd)
	...
	if not IsValid(ply:GetActiveWeapon()) or ply:GetActiveWeapon():GetClass() ~= "weapon_physgun" then return end
