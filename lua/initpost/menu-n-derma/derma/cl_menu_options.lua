...
hg.settings:AddOpt("UI", "zb_esp_auto_performance", "ESP auto performance scaling", nil, nil, "bool")
hg.settings:AddOpt("UI", "zb_esp_show_outlines", "ESP player outlines", nil, nil, "bool")
hg.settings:AddOpt("UI", "zb_esp_outline_limit", "ESP max player outlines (0 = auto)", true, nil, "int")
